...
import { cleanFilters, cleanFiltersForStorage, hasMeaningfulFilters } from "../utils/filter-utils";
...
import { MultiSelectExtendable } from "../../multiselect-extendable";
import { MultiSelectExtendableAsync } from "../../multiselect-extendable/async";
...
import { useDiscoverConfig } from "../discover-config";
...
const TrendlyAdvancedFilter = ({
    ...
    const config = useDiscoverConfig();
    const { selectedBrand, updateBrand } = config;

    // Use dynamic niches from config
    const { niches: dynamicNiches, getAllNiches, searchNiches, isLoadingNiches } = config;
