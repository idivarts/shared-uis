...
import { buildDiscoveryPayload } from "./utils/filter-utils";
...
import ProfileBottomSheet from "../ProfileModal/Profile-Modal";
...
const DiscoverInfluencer: React.FC<DiscoverInfluencerProps> = ({
    ...
    const { managerId, isAdmin, selectedBrand, isOnFreeTrial, isProfileLocked } = config;
    const { InfluencerCard, InviteToCampaignButton, BottomSheetScrollContainer } = config.components;
