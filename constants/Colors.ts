...
export const ColorsStatic = {
    ...
    overlayWhite80Alt: "rgba(255,255,255,0.8)",
    overlayWhite40: "rgba(255, 255, 255, 0.4)",
    borderDivider: "rgb(224, 224, 224)",
    gradientBanner1: "rgb(238, 242, 255)",
    gradientBanner2: "rgb(253, 242, 248)",
    gradientBannerAlt1: "rgb(230, 255, 251)",
    gradientBannerAlt2: "rgb(240, 249, 255)",
    surfaceTint: "rgb(248, 249, 255)",
    surfaceTintAlt: "rgb(248, 250, 252)",
    progressBarTrack: "rgb(221, 221, 221)",
    progressBarFill: "rgb(52, 152, 219)",
    gradientDrawer1: "rgb(59, 130, 246)",
    gradientDrawer2: "rgb(139, 92, 246)",
    gradientOfferActive1: "rgb(142, 45, 226)",
    gradientOfferActive2: "rgb(233, 64, 87)",
    gradientOfferActive3: "rgb(242, 113, 33)",
    gradientOfferExpired1: "rgb(67, 67, 67)",
    gradientOfferExpired2: "rgb(44, 62, 80)",
    gradientOfferExpired3: "rgb(31, 41, 55)",
    surfaceAvatar: "rgb(236, 236, 236)",
    textMutedDark: "rgb(14, 91, 77)",
    textMutedGray: "rgb(96, 103, 114)",
    accentButton: "rgb(55, 120, 244)",
    avatarAccent: "rgb(255, 214, 0)",
    textDark: "rgb(68, 68, 68)",
    footerBg: "rgb(31, 63, 115)",
    footerTextMuted: "rgb(214, 226, 245)",
}
